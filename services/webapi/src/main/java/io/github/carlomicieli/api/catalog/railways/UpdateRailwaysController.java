...
import io.github.carlomicieli.catalog.railways.RailwayRequest;
...
public class UpdateRailwaysController {
    @Put("/{railwayId}")
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(value = {MediaType.APPLICATION_JSON_PROBLEM})
    public HttpResponse<Railway> handle(
            @PathVariable("railwayId") String railwayId, @Body RailwayRequest railwayRequest) {
        RailwayId railwayIdValue = new RailwayId(railwayId);
        Railway railway = RailwayBuilder.builder()
                .railwayId(railwayIdValue)
                .name(railwayRequest.name())
                .build();
