...
class BrandIdTest {
    ...
    void it_should_throw_an_IllegalArgumentException_when_the_input_is_not_valid() {
        IllegalArgumentException exception = assertThrowsExactly(IllegalArgumentException.class, () -> new BrandId(""));
        assertNotNull(exception);
        assertEquals("brand id cannot be null or blank", exception.getMessage());
    }

    @Test
    void it_should_create_brand_id_from_string() {
        BrandId brandId = new BrandId("hello world");
